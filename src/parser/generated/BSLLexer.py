# Generated from src/parser/grammar/BSLLexer.g4 by ANTLR 4.13.2
import sys
...
class BSLLexer(Lexer):
    ...
    channelNames = ["DEFAULT_TOKEN_CHANNEL", "HIDDEN", "PREPROC_DELETE_CHANNEL"]
