...
class BSLParser(Parser):
    ...
    class Preproc_expressionContext(ParserRuleContext):
        ...
        def preproc_logicalExpression(self):
            return self.getTypedRuleContext(
                BSLParser.Preproc_logicalExpressionContext, 0
            )
    ...
    class Preproc_logicalExpressionContext(ParserRuleContext):
        ...
        def preproc_logicalOperand(self, i: int = None):
            if i is None:
                return self.getTypedRuleContexts(
                    BSLParser.Preproc_logicalOperandContext
                )
            else:
                return self.getTypedRuleContext(
                    BSLParser.Preproc_logicalOperandContext, i
                )
        ...
        def preproc_boolOperation(self, i: int = None):
            if i is None:
                ...
                return self.getTypedRuleContext(
                    BSLParser.Preproc_boolOperationContext, i
                )
    ...
    def preproc_logicalExpression(self):
        localctx = BSLParser.Preproc_logicalExpressionContext(
    ...
    class Preproc_symbolContext(ParserRuleContext):
        ...
        def PREPROC_THICKCLIENTORDINARYAPPLICATION_SYMBOL(self):
            return self.getToken(
                BSLParser.PREPROC_THICKCLIENTORDINARYAPPLICATION_SYMBOL, 0
            )

        def PREPROC_THICKCLIENTMANAGEDAPPLICATION_SYMBOL(self):
            return self.getToken(
                BSLParser.PREPROC_THICKCLIENTMANAGEDAPPLICATION_SYMBOL, 0
            )
    ...
    class CompilerDirectiveSymbolContext(ParserRuleContext):
        ...
        def ANNOTATION_ATCLIENTATSERVERNOCONTEXT_SYMBOL(self):
            return self.getToken(
                BSLParser.ANNOTATION_ATCLIENTATSERVERNOCONTEXT_SYMBOL, 0
            )
    ...
    class ModuleVarsListContext(ParserRuleContext):
        ...
        def moduleVarDeclaration(self, i: int = None):
            if i is None:
                ...
                return self.getTypedRuleContext(
                    BSLParser.ModuleVarDeclarationContext, i
                )
    ...
    def procDeclaration(self):
        ...
        try:
            ...
            self._errHandler.sync(self)
            _la = self._input.LA(1)
            if (((_la - 23)) & ~0x3F) == 0 and (
                (1 << (_la - 23)) & 9007199263129601
            ) != 0:
                self.state = 498
                self.paramList()
    ...
    def unaryModifier(self):
        ...
        try:
            ...
            if not (
                (
                    (((_la - 12)) & ~0x3F) == 0
                    and ((1 << (_la - 12)) & 18014398509481987) != 0
                )
            ):
                self._errHandler.recoverInline(self)
            else:
