    ...
    actions: list[dict[str, Any]] = [
        {
            ...
            "priority": "medium",
            "status": "generated-skeleton",
            "reason": "Add assertions around the generated entrypoint contract.",
        }
    ]
...
def _function_code(entrypoint: str, prompt: str, comments: list[str]) -> str:
    lines = [
        *comments,
        ...
        '    Result.Insert("status", "planned");',
        f'    Result.Insert("entrypoint", "{entrypoint}");',
        f'    Result.Insert("requirement", "{_safe_comment(prompt, limit=220)}");',
        "",
        "    // TODO: implement domain logic using the grounded metadata and impact plan.",
        "    // TODO: replace planned status with a business result after review.",
        "",
        "    Return Result;",
        "",
        "EndFunction",
...
def _procedure_code(entrypoint: str, prompt: str, comments: list[str]) -> str:
    lines = [
        *comments,
        ...
        "    // TODO: implement the command after confirming side effects and rights.",
        "    // TODO: emit audit or registration log in the caller-owned layer.",
        "",
        "EndProcedure",
        "",
    ]
...
def _test_code(entrypoint: str, prompt: str, comments: list[str]) -> str:
    ...
    lines = [
        *comments,
        ...
        "",
        "    // TODO: assert expected fields with the project test framework.",
        "    // Example: Assert(Result <> Undefined);",
        "",
        "EndProcedure",
        "",
    ]
