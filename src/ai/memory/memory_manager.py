...
from src.ai.memory.schemas import MemoryItem, MemorySource, Provenance
...
class Memorizer:
    ...
    def __init__(self, storage_adapter=None):
        ...
        """
        self.storage = (
            storage_adapter if storage_adapter else {}
        )  # In-memory storage: id -> MemoryItem
        self.logger = logger
