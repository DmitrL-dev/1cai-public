...
| Применить правку в копии | В исходной ветке после dev8: CLI workspace create/apply/undo/status/recover с проверкой inventory, backup, re-read и явным восстановлением; в core-v0.1.0.dev8 не входит |
...
Таблица включает возможности текущей исходной ветки. Архивный core-v0.1.0.dev8
из [первой инструкции](GETTING_STARTED.md) содержит только выпущенный срез;
для workspace writer, EDT planner и новых native adapters нужен checkout
зафиксированной ветки разработки.
