...
> Текущий профиль: Windows x64, Python 3.11; core `0.1.0.dev7`, companion `0.1.4`.
> Сквозной сценарий с реальной платформой 1С ещё не принят.

Ветка разработки `codex/snapshot-observer-dev8` добавляет в исходники ядра
[сравнение сохранённых снимков](docs/product/SNAPSHOT-DIFF.md). Это отдельный
проверяемый шаг к непрерывному аудиту. Поставки и профиль редактора выше остаются
на dev7; сборку dev8 устанавливают в отдельное окружение.
