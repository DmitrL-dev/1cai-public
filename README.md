...
| Архивировать native-run | Явный admin-only CLI/API logical archive с проверенным audit, сохранением evidence и UUID; слот retained освобождается логически, дисковое место не удаляется |
