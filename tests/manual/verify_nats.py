...
async def main():
    ...
    with patch(
        "src.modules.ai_orchestration.infrastructure.llm.LLMFactory.create",
        ...
        event = Event(
            type=EventType.AI_AGENT_STARTED,
            payload={"message": "Triggered via NATS", "thread_id": "nats-test-1"},
        )
