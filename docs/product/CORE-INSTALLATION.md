...
Срез исходников `rentgen-core 0.1.0.dev10`, Windows x64 / CPython 3.11. Это CLI снимков,
...
Для комплекта с scanner и всеми зависимостями MCP используйте
[сборку и проверку офлайн-комплекта](CORE-OFFLINE-KIT.md). Она сравнивает две
сборки и проверяет установку из локальных wheels в новом окружении.
...
.\.venv-core\Scripts\python.exe -m pip install --no-index --no-deps .\dist\rentgen_core-0.1.0.dev10-py3-none-any.whl
...
.\.venv-mcp\Scripts\python.exe -m pip install --no-index --no-deps ".\dist\rentgen_core-0.1.0.dev10-py3-none-any.whl[mcp]"
