...
Срез исходников `rentgen-core 0.1.0.dev9`, Windows x64 / CPython 3.11. Это CLI снимков,
...
.\.venv-core\Scripts\python.exe -m pip install --no-index --no-deps .\dist\rentgen_core-0.1.0.dev9-py3-none-any.whl
...
.\.venv-mcp\Scripts\python.exe -m pip install --no-index --no-deps ".\dist\rentgen_core-0.1.0.dev9-py3-none-any.whl[mcp]"
