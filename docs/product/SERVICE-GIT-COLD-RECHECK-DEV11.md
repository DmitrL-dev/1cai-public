...
Позднейшая [проверка на новых регистрациях проектов](SERVICE-GIT-NEW-PROJECT-DEV11.md)
воспроизвела первый отказ полного публичного worker на другом свежем runtime,
после чего повтор того же проекта прошёл. Её [отдельная квитанция](evidence/service-git-new-project-dev11-20260925.json)
не входит в описанные выше две положительные контрпробы; внутренний код
причины нового отказа не захвачен.
