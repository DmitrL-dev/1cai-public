...
успешно и потомок кеша, уже прошедший проверенное удаление, появился в первом
перечислении родителя, затем исчез при повторном и новом перечислениях;
повторное открытие вернуло WinError `2`. [Квитанция](evidence/service-git-cleanup-trace-dev11-20260925.json)
