...
## Кандидат после dev9 — локальный HTTPS-приём уведомлений
...
проверяются исходные заголовки, `Content-Length`, лимит и завершение тела,
HTTPS-схема и успешный lifespan startup. Локальный Uvicorn/TLS тест отправляет
...
не входит в опубликованный dev9.
