...
| Ежедневная разработка dev8 | AI-правка, BSL, проверка той же ревизии в 1С и восстановление связаны в одном профиле/редакторе | [Сценарий не принят](DAILY-DEVELOPMENT-ACCEPTANCE.md): модель сохранила проглатывание исключения; ручное исправление черновика в редакторе ещё отсутствует |
