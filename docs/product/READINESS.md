...
Продуктовый адаптер preview/apply/undo ещё не реализован; выпуски dev8/0.1.8
этой возможностью не дополняются задним числом.
...
| Прямое изменение метаданных | EDT preview Article → SKU, два diff, проверка UUID/формы и сохранность трёх записей при миграции/возврате | Apply/undo, stale/conflict и матрица типовых конфигураций не приняты |
