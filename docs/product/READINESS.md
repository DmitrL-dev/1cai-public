...
| Обновления конфигураций | Path-bytes и первый UUID-aware Designer XML three-way dry-run с bounded хэшами и явными конфликтами | Property/extension/BSL semantics, тестовая база, backup/rollback и запись не приняты |
